    ...
    <div className="flex flex-col h-dvh bg-white">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
        ...
        <div className="flex rounded-2xl bg-gray-100 p-1">
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-colors ${
              type === 'expense' ? 'bg-expense text-white shadow-sm' : 'text-gray-500'
            }`}
          >
            Expense
          </button>
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-colors ${
              type === 'income' ? 'bg-income text-white shadow-sm' : 'text-gray-500'
            }`}
          >
            Income
          </button>
        ...
        <div className="grid grid-cols-3 gap-2">
          {['1', '2', '3', '4', '5', '6', '7', '8', '9', '.', '0', '⌫'].map(key => (
            <button
              ...
              className="py-4 text-xl font-semibold text-gray-800 bg-gray-50 rounded-2xl active:bg-gray-200 transition-colors"
            >
              {key}
            </button>
          ))}
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-2xl border border-gray-200 text-sm focus:outline-none focus:border-primary-400 focus:ring-2 focus:ring-primary-100"
        />
        ...
        <select
          ...
          className="w-full px-4 py-3 rounded-2xl border border-gray-200 text-sm text-gray-700 bg-white focus:outline-none focus:border-primary-400"
        >
        ...
        <input
          ...
          className="w-full px-4 py-3 rounded-2xl border border-gray-200 text-sm text-gray-700 focus:outline-none focus:border-primary-400"
        />
      </div>

      {/* Save button */}
      <div className="px-4 py-4 border-t border-gray-100 pb-[env(safe-area-inset-bottom)]">
        <button
          onClick={handleSave}
